...
function M.config()
    ...
    vim.keymap.set("n", "<leader>gz", function()
        builtin.git_stash(require("telescope.themes").get_ivy { winblend = 0,  } )
    ...
    vim.keymap.set('n', '<leader>sh', function()
        builtin.help_tags(require("telescope.themes").get_ivy { winblend = 0,  } )
    end, { desc = '[ ] Find help' })

    vim.keymap.set('n', '<localleader>tq', function() builtin.quickfixhistory(require("telescope.themes").get_ivy { winblend = 0,  } ) end, { desc = '[ ] Find quickfixhistory' })
    vim.keymap.set('n', '<localleader>tc', function() builtin.command_history(require("telescope.themes").get_ivy { winblend = 0,  } ) end, { desc = '[ ] Find command_history' })
    vim.keymap.set('n', '<localleader>t/', function() builtin.search_history(require("telescope.themes").get_ivy { winblend = 0,  } ) end, { desc = '[ ] Find search_history' })
