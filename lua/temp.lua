...
local function nhighlight_visual(color)
    local hl_group = hl_groups[color]
    ...
    vim.ui.select(
        {'y', 'v', 'g', 'r', 'b'},
        {
            ...
            format_item = function(item)
                local labels = {
                    y = 'Yellow (DiagnosticWarn)',
                    v = 'Violet (DiagnosticHint)',
                    g = 'Green (DiagnosticInfo)',
                    r = 'Red (DiagnosticError)',
                    b = 'Blue (Keyword)',
                }
...
vim.keymap.set('v', '<leader>h', prompt_and_highlight, { desc = 'Highlight visual selection' })
vim.keymap.set('n', '<localleader>md', prompt_and_remove_highlight, { desc = 'remove a Highlight' })
...
vim.keymap.set('n', '<localleader>mp', npersist_highlights, { desc = 'persist highlights' })
vim.keymap.set('n', '<localleader>ml', nresume_highlights, { desc = 'load highlights' })
